...
export default function LiveCallDock({ controller, className }: LiveCallDockProps) {
  ...
  return (
    <div className={`rounded-3xl border border-border bg-card/70 shadow-2xl backdrop-blur-xl ${className || ""}`}>
        ...
        <AnimatePresence mode="wait">
          {controller.phase === "ringing" && controller.incomingCall ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              className="relative space-y-4 rounded-2xl border border-primary/25 bg-primary/10 p-4"
            >
              <div className="flex items-center gap-3">
                <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/20 text-primary">
