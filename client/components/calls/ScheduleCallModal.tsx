...
export default function ScheduleCallModal({
 ...
 <DialogContent className="max-w-xl rounded-lg border-border bg-background/95 p-0 backdrop-blur-xl">
 ...
 className={`flex items-center justify-center gap-2 rounded-lg border px-4 py-3 text-xs font-black uppercase tracking-wider transition-all ${
 callType === "VIDEO"
 ...
 rows={4}
 className="w-full rounded-lg border border-border bg-muted/40 py-2 pl-10 pr-3 text-sm text-foreground outline-none transition-all focus:ring-2 focus:ring-primary/30"
 maxLength={1500}
 />
 </div>
