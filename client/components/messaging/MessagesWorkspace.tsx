...
export default function MessagesWorkspace({
 ...
 return (
 <div className={`flex overflow-hidden bg-background ${fullHeight ? "h-[calc(100dvh-6rem)]" : "h-[720px] rounded-lg border border-border"}`}>
 ...
 <div className="mx-auto h-24 w-24 animate-pulse rounded-lg bg-gradient-to-br from-primary to-primary/60 p-0.5 shadow-2xl shadow-primary/20">
 ...
 <div className="flex flex-col items-center gap-2 rounded-lg border border-border bg-card/50 p-4 text-center backdrop-blur-sm">
