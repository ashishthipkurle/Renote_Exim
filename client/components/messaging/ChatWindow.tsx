              ...
              >
                ...
                <div 
                  className={`max-w-[85%] sm:max-w-[70%] px-4 py-3 text-sm transition-all duration-300 ${
                    isMe 
                      ? "bg-primary text-primary-foreground rounded-2xl rounded-tr-none shadow-[0_4px_15px_rgba(19,91,236,0.25)]" 
        ...
        >
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full bg-background border border-border rounded-2xl px-4 py-3 pr-12 text-sm focus:ring-2 focus:ring-primary/20 outline-none resize-none min-h-[44px] max-h-[120px]"
              rows={1}
            />
