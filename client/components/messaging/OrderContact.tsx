    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-2xl h-[600px] bg-background rounded-3xl overflow-hidden shadow-2xl border border-border flex flex-col relative animate-in fade-in zoom-in duration-300">
            <button 
