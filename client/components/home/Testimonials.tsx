...
export default function Testimonials() {
 ...
 className="group"
 >
 <div className="relative h-full p-8 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-800/80 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-xl transition-all duration-300">
 {/* Quote Icon */}
