...
export default function Hero() {
 ...
 className="absolute top-10 left-10 bg-white dark:bg-slate-800 p-6 rounded-lg shadow-2xl"
 >
 ...
 className="absolute bottom-10 right-10 bg-white dark:bg-slate-800 p-6 rounded-lg shadow-2xl"
 >
 <div className="flex items-center gap-3">
