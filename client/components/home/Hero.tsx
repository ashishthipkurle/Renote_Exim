          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-300">Verified Businesses</span>
              </div>
              <div className="flex items-center gap-2">
                <Globe className="text-blue-600" size={20} />
                <span className="text-sm text-slate-600 dark:text-slate-300">190+ Countries</span>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative aspect-square">
              ...
              <motion.div
                ...
                className="absolute top-10 left-10 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-2xl"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-600 dark:text-slate-400">Export Volume</p>
              ...
              <motion.div
                ...
                className="absolute bottom-10 right-10 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-2xl"
              >
                <div className="flex items-center gap-3">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-64 h-64">
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-full border-4 border-dashed border-blue-200 dark:border-blue-800"
                  />
                  <motion.div
                    animate={{ rotate: -360 }}
                    transition={{
                    ...
                    className="absolute inset-8 rounded-full border-4 border-dashed border-purple-200 dark:border-purple-800"
                  />
                  <div className="absolute inset-0 flex items-center justify-center">
