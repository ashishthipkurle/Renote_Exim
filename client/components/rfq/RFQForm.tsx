...
export default function RFQForm({ onSubmitSuccess }: { onSubmitSuccess?: () => void }) {
 ...
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Requirement Signature</label>
 ...
 <input
 required
 className="w-full bg-muted/20 border border-border rounded-xl h-12 pl-11 pr-4 text-white focus:border-white/20 focus:bg-muted/40 transition-all outline-none placeholder:text-muted-foreground/30 font-medium "
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Asset Node Class</label>
 <div className="relative group">
 <select
 className="w-full bg-muted/20 border border-border rounded-xl h-12 px-4 text-white outline-none focus:border-white/20 focus:bg-muted/40 transition-all appearance-none font-medium "
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Deadline Protocol</label>
 <div className="relative group">
 ...
 <div className="grid grid-cols-2 gap-6">
 <div className="space-y-2">
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Volume Metric</label>
 <div className="relative group">
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Capital Threshold (USD)</label>
 <div className="relative group">
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1 ">Intelligence Briefing</label>
 <textarea
 required
 rows={4}
 className="w-full bg-muted/20 border border-border rounded-xl p-4 text-white outline-none focus:border-white/20 focus:bg-muted/40 transition-all resize-none placeholder:text-muted-foreground/30 font-medium leading-relaxed"
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-white hover:bg-neutral-200 text-black h-14 rounded-lg font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 shadow-2xl shadow-white/10 transition-all hover:-translate-y-1 active:translate-y-0 text-[10px] disabled:opacity-50"
 >
