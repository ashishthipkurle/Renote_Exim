...
export default function CookieConsent() {
 ...
 >
 <div className="bg-black border border-white/10 rounded-lg p-6 shadow-2xl shadow-black ring-1 ring-white/5 relative overflow-hidden group">
 ...
 <h3 className="text-[10px] font-black text-white uppercase tracking-[0.2em] ">Compliance Protocol</h3>
 <button 
