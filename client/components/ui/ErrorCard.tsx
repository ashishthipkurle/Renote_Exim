...
export default function ErrorCard({
 ...
 <div className="w-20 h-20 bg-muted/20 backdrop-blur-3xl border border-border rounded-lg flex items-center justify-center mb-8 text-white shadow-2xl relative group">
 ...
 <h2 className="text-3xl font-black text-white mb-4 tracking-tighter uppercase shadow-[0_0_20px_rgba(255,255,255,0.1)]">{title}</h2>
 ...
 <Link href="/" className="bg-muted/40 hover:bg-muted/60 text-white px-8 h-12 rounded-lg border border-border transition-all flex items-center gap-3 font-black uppercase tracking-[0.2em] text-[10px] hover:-translate-y-1 active:translate-y-0">
 ...
 <pre className="p-6 bg-black border border-border rounded-lg text-[10px] text-muted-foreground font-mono overflow-auto w-full leading-relaxed shadow-inner">
 {error.stack}
 </pre>
 </div>
 )}
