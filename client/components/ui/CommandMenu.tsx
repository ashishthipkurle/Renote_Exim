...
export default function CommandMenu() {
 ...
 className="w-full max-w-[640px] overflow-hidden rounded-lg bg-black border border-white/10 shadow-2xl ring-1 ring-white/5 animate-in zoom-in-95 duration-300"
 >
 ...
 className="flex h-20 w-full bg-transparent py-4 text-sm outline-none placeholder:text-muted-foreground/20 text-white font-medium "
 />
 </div>
 ...
 <Command.Group heading="Navigation" className="px-3 py-4 text-[10px] font-black text-white/20 uppercase tracking-[0.2em] ">
 <Command.Item
 onSelect={() => runCommand(() => router.push('/dashboard'))}
 className="flex items-center gap-4 px-4 py-4 rounded-lg text-muted-foreground hover:bg-white/5 hover:text-white cursor-pointer transition-all group"
 >
 ...
 <Command.Group heading="Procurement" className="px-3 py-4 text-[10px] font-black text-white/20 uppercase tracking-[0.2em] ">
 <Command.Item
 ...
 <Command.Group heading="System" className="px-3 py-4 text-[10px] font-black text-white/20 uppercase tracking-[0.2em] ">
 <Command.Item
