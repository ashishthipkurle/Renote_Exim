...
export function ErrorState({
  ...
  return (
    ...
    >
      <div className="w-24 h-24 bg-muted/20 backdrop-blur-3xl border border-border rounded-[2.5rem] flex items-center justify-center mb-8 text-white shadow-2xl relative group">
      ...
      <h3 className="text-2xl font-black text-white mb-3 tracking-tighter uppercase italic">{title}</h3>
