...
export default function FeaturesSection() {
 ...
 <div className="bg-slate-900 border border-slate-800 dark:bg-transparent rounded-lg p-8 relative group overflow-hidden h-[450px] flex flex-col justify-end hover:shadow-2xl dark:hover:shadow-[0_0_40px_rgba(19,91,236,0.15)] reveal-trigger" style={{ transitionDelay: "0ms" }}>
 ...
 <div className="bg-slate-900 border border-slate-800 dark:bg-transparent rounded-lg p-8 relative group overflow-hidden h-[450px] flex flex-col justify-end hover:shadow-2xl dark:hover:shadow-[0_0_40px_rgba(19,91,236,0.15)] reveal-trigger" style={{ transitionDelay: "150ms" }}>
 <div className="absolute inset-0 z-0">
 <Image
 ...
 <div className="bg-slate-900 border border-slate-800 dark:bg-transparent rounded-lg p-8 relative group overflow-hidden h-[450px] flex flex-col justify-end hover:shadow-2xl dark:hover:shadow-[0_0_40px_rgba(19,91,236,0.15)] reveal-trigger" style={{ transitionDelay: "300ms" }}>
 <div className="absolute inset-0 z-0">
 <Image
