...
export default function ComplianceSection() {
 ...
 <span className="text-primary text-sm font-bold uppercase tracking-widest mb-2 block drop-shadow-sm">{t("compliance.badge", "Bureaucracy Simplified")}</span>
 <h2 className="text-4xl font-bold text-foreground mb-6 drop-shadow-sm">{t("compliance.title_part1", "SMART TRADE")} <br /><span className="text-primary">{t("compliance.title_part2", "COMPLIANCE")}</span></h2>
 <p className="text-muted-foreground max-w-2xl mx-auto font-medium drop-shadow-sm">{t("compliance.subtitle", "Navigate complex international regulations with our AI-driven legal engine. We handle the paperwork so you can focus on the deal.")}</p>
 </div>
 ...
 <h3 className="text-xl font-bold text-foreground mb-3">{t("compliance.card1_title", "Automated Customs")}</h3>
 <p className="text-sm text-muted-foreground leading-relaxed font-medium">
 {t("compliance.card1_desc", "Instantly generate HS codes, commercial invoices, and packing lists compliant with destination country laws.")}
 </p>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t("compliance.card2_title", "VAT/Tax Intelligence")}</h3>
 <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
 {t("compliance.card2_desc", "Real-time calculation of landed costs including duties, taxes, and port fees for accurate profit forecasting.")}
 </p>
 <div className="mt-6 pt-6 border-t border-slate-300/50 dark:border-white/10 flex items-center justify-between">
 <span className="text-xs font-mono text-blue-700 dark:text-blue-400 font-bold">{t("compliance.card2_stat", "Global Coverage")}</span>
 <span className="material-icons text-slate-500 dark:text-slate-400 text-sm group-hover:text-primary transition-colors">arrow_forward</span>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t("compliance.card3_title", "Blockchain Ledger")}</h3>
 <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
 {t("compliance.card3_desc", "Immutable record keeping for every transaction and document version, ensuring audit-proof trade history.")}
 </p>
 <div className="mt-6 pt-6 border-t border-slate-300/50 dark:border-white/10 flex items-center justify-between">
