                ...
                <div className="w-full md:w-[55%] space-y-8 reveal-trigger pl-0 md:pl-10" style={{ transitionDelay: "200ms" }}>
                    ...
                    <div className="space-y-4 pt-4 max-w-xl">
                        <div
                            ...
                            className="group flex items-center gap-6 p-6 rounded-lg bg-white/40 dark:bg-[#0A0E17]/40 backdrop-blur-sm border border-slate-200 dark:border-white/5 hover:border-primary/50 transition-all cursor-pointer hover:shadow-lg hover:shadow-primary/20 dark:hover:shadow-primary/10"
                        >
