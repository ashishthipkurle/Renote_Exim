...
export default function SupplierSidebar({ basePath }: { basePath: string }) {
 ...
 { href: `${basePath}/exporters`, label: "Exporters Hub", icon: Handshake },
 { href: `${basePath}/products`, label: "Supply Items", icon: Boxes },
 { href: `${basePath}/orders`, label: "Supply Orders", icon: FolderTree },
