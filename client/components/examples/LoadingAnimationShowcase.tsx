...
export default function LoadingAnimationShowcase() {
 ...
 <div className="rounded-lg bg-white dark:bg-[#101622] p-8 border border-slate-200 dark:border-white/10 shadow-lg">
...
export default function MyComponent() {
 ...
 <div className="rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/5 p-6 border border-primary/20">
