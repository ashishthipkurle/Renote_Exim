...
export default function ProductForm({
 ...
 const inputClass =
 "w-full px-5 py-4 bg-background border border-border focus:border-primary rounded-lg text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none transition-all shadow-sm";
 ...
 className="inline-flex items-center gap-2 bg-white hover:bg-neutral-100 text-black font-black text-xs uppercase tracking-[0.2em] py-4 px-8 rounded-lg shadow-2xl shadow-white/10 transition-all active:scale-95 disabled:opacity-50"
 >
 ...
 {/* Basic Info */}
 <div className="bg-card backdrop-blur-xl border border-border shadow-2xl rounded-lg p-10 space-y-8 relative overflow-hidden group">
 ...
 <h2 className="text-sm font-black text-foreground tracking-[0.25em] uppercase opacity-50 mb-4 ">{t("product_form.core_specs", "Core Specifications")}</h2>
 ...
 />
 <p className="text-[9px] text-white/60 mt-2 ml-1 font-medium uppercase tracking-wider">This will create a new unique sector for your listing</p>
 </div>
 )}
 </div>
 <div>
 ...
 {/* Pricing */}
 <div className="bg-card backdrop-blur-xl border border-border shadow-2xl rounded-lg p-10 space-y-8 relative overflow-hidden group">
 <h2 className="text-sm font-black text-foreground tracking-[0.25em] uppercase opacity-50 mb-4 ">{t("product_form.trade_economics", "Trade Economics")}</h2>
 ...
 className={inputClass}
 />
 <p className="text-[9px] text-muted-foreground mt-2 ml-1 font-medium uppercase tracking-wider">Crucial for international customs processing</p>
 </div>
 </div>
 </div>
 ...
 {/* Visual Assets */}
 <div className="bg-card backdrop-blur-xl border border-border shadow-2xl rounded-lg p-8 space-y-6">
 <h2 className="text-[11px] font-black text-foreground tracking-[0.25em] uppercase opacity-50 ">{t("product_form.asset_gallery", "Asset Gallery")}</h2>
 ...
 {/* Professional Certs */}
 <div className="bg-card backdrop-blur-xl border border-border shadow-2xl rounded-lg p-8 space-y-6">
 <h2 className="text-[11px] font-black text-foreground tracking-[0.25em] uppercase opacity-50 ">{t("product_form.trust_markers", "Trust Markers")}</h2>
 ...
 {/* Status Guard */}
 <div className="bg-muted border border-border rounded-lg p-8 relative overflow-hidden group">
 ...
 <ul className="text-[10px] text-muted-foreground mt-4 space-y-2 font-medium leading-relaxed">
 ...
 {/* Final Action */}
 <div className="lg:col-span-12 flex items-center justify-between bg-card/80 backdrop-blur-2xl border border-border rounded-lg p-8 mt-4 shadow-2xl">
 ...
 <p className="text-muted-foreground text-[10px] uppercase font-bold tracking-wider mt-1 ">Authorized Listing Procedure (ALP-1)</p>
 </div>
 <div className="flex items-center gap-4 w-full sm:w-auto">
 <Link
 href="/dashboard/exporter/inventory"
 className="flex-1 sm:flex-none px-10 py-4 text-muted-foreground border border-border hover:text-foreground hover:bg-muted font-black text-[10px] uppercase tracking-widest rounded-lg transition-all"
 >
 ...
 type="submit"
 disabled={isSubmitting}
 className="flex-1 sm:flex-none relative group px-12 py-4 bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground font-black text-[10px] uppercase tracking-[0.3em] rounded-lg shadow-2xl shadow-primary/10 transition-all active:scale-95 overflow-hidden"
 >
