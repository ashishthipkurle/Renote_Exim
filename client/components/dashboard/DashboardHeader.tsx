        ...
        <header className="h-16 lg:h-20 bg-[#0b1019]/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-[100] flex items-center px-4 lg:px-8">
            ...
            <div className="flex items-center gap-4 w-60 flex-shrink-0">
                ...
                <div className="hidden md:block">
                    <h1 className="text-lg font-black text-white leading-none uppercase tracking-tighter">
            ...
            <button
                ...
                className="size-9 lg:size-10 bg-white/5 hover:bg-white/10 border border-white/5 rounded-xl flex items-center justify-center text-slate-400 hover:text-white transition-all active:scale-95 ml-2 lg:ml-0"
            ...
            <div className="flex-1 max-w-xl ml-8 lg:ml-20 hidden md:block">
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="w-full bg-[#151c2a]/60 border border-white/5 focus:border-primary/40 rounded-2xl pl-11 pr-4 py-2.5 text-xs text-white placeholder:text-slate-600 outline-none transition-all shadow-inner font-medium italic"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-2 lg:gap-4 ml-auto">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-right hidden sm:block">
                        <p className="text-[10px] font-black text-white uppercase tracking-wider">{user?.name || "EXPORTER"}</p>
                        <p className="text-[8px] font-bold text-slate-500 uppercase tracking-widest mt-0.5 italic">Protocol verified</p>
                    </div>
                    <div className="size-9 lg:size-10 rounded-xl border-2 border-white/10 overflow-hidden cursor-pointer hover:border-primary transition-all p-0.5 bg-slate-800 shadow-lg group">
                        {user?.avatar ? (
                            <Image
                                alt="User"
                                width={40} height={40}
