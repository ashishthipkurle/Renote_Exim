                ...
                <div className="flex h-full items-center px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-2 lg:gap-4">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {isProfileOpen && (
                                <div className="absolute right-0 mt-2 w-64 p-2 rounded-2xl border border-border dark:border-white/10 bg-background/95 backdrop-blur-xl shadow-2xl animate-in fade-in zoom-in-95 z-50">
                                    <div className="p-3">
