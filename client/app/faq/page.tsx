      ...
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="mt-12 relative max-w-xl mx-auto">
            ...
            <input 
              ...
              className="w-full h-14 bg-slate-900/50 border border-slate-800 rounded-2xl pl-12 pr-6 text-white outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-slate-600"
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          {filteredFaqs.map((faq, index) => (
            <div 
              key={index}
              className="bg-slate-900/50 border border-slate-800 rounded-2xl overflow-hidden overflow-visible"
            >
              <button 
        ...
        <div className="mt-20 p-8 bg-blue-600 rounded-3xl relative overflow-hidden group">
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-white mb-2">Still have questions?</h3>
              <p className="text-blue-100 italic">Can't find the answer you're looking for? Please chat to our friendly team.</p>
            </div>
