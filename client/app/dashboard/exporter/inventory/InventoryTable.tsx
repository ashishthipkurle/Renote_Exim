...
export default function InventoryTable({
 ...
 className="w-full pl-14 pr-6 py-4 bg-card/40 dark:bg-white/5 border border-border dark:border-white/5 rounded-lg text-foreground dark:text-white placeholder:text-muted-foreground/30 focus:outline-none focus:border-border dark:border-white/20 focus:bg-card/60 dark:bg-white/[0.07] transition-all text-xs font-black uppercase tracking-widest backdrop-blur-xl"
 />
 ...
 className="appearance-none pl-12 pr-10 py-4 bg-card/40 dark:bg-white/5 border border-border dark:border-white/5 rounded-lg text-[10px] text-foreground dark:text-white font-black uppercase tracking-widest focus:outline-none focus:border-border dark:border-white/20 hover:bg-card/60 dark:bg-white/[0.07] transition-all cursor-pointer backdrop-blur-xl "
 >
 <option value="" className="bg-card dark:bg-[#0a0a0a] text-foreground dark:text-white lowercase font-sans">Global Sector</option>
 ...
 <option key={c} value={c} className="bg-card dark:bg-[#0a0a0a] text-foreground dark:text-white lowercase font-sans">
 {c}
 </option>
 ))}
 </select>
 ...
 className="px-6 py-4 text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground/40 hover:text-foreground dark:text-white transition-all "
 >
 Reset Grid
 </button>
 )}
 ...
 <div className="p-6 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/10 animate-pulse">
 <Globe className="w-8 h-8 text-foreground dark:text-white animate-spin-slow" />
 </div>
 <p className="text-[9px] font-black text-foreground dark:text-white uppercase tracking-[0.3em] ">Updating Registry...</p>
 </div>
 </motion.div>
 )}
 </AnimatePresence>

 <div className="hidden lg:grid grid-cols-12 gap-8 px-10 text-[9px] font-black text-muted-foreground/30 uppercase tracking-[0.3em] ">
 ...
 <h2 className="text-2xl font-black text-foreground dark:text-white uppercase tracking-tighter">Null_Registry_Record</h2>
 ...
 className="inline-flex items-center gap-3 bg-primary hover:bg-primary/90 text-primary-foreground font-black text-[10px] uppercase tracking-[0.2em] py-4 px-10 rounded-lg shadow-2xl shadow-white/5 transition-all active:scale-95 "
 >
 ...
 <div
 key={product.id}
 className={`bg-card/40 dark:bg-white/5 backdrop-blur-3xl border border-border dark:border-white/5 hover:border-border dark:border-white/20 transition-all duration-700 shadow-xl dark:shadow-2xl rounded-lg p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center group ${isDeletingId === product.id ? "opacity-20 pointer-events-none scale-95" : "hover:-translate-y-1"
 }`}
 >
 <div className="lg:col-span-5 flex items-center gap-8">
 <div className="size-20 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/5 flex-shrink-0 overflow-hidden flex items-center justify-center group-hover:border-border dark:border-white/20 transition-all duration-700 p-2 shadow-inner">
 {product.images?.[0] ? (
 ...
 <div className="text-xl font-black text-foreground dark:text-white truncate tracking-tighter uppercase group-hover:translate-x-1 transition-transform">{product.name}</div>
 <div className="text-[9px] text-muted-foreground/30 mt-2 line-clamp-1 font-black uppercase tracking-widest group-hover:text-muted-foreground/60 transition-colors">
 ...
 <span className="inline-flex items-center px-5 py-2 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/10 text-[9px] text-foreground dark:text-white font-black uppercase tracking-[0.2em] group-hover:bg-primary group-hover:text-primary-foreground transition-all">
 {product.category}
 </span>
 </div>

 <div className="lg:col-span-2">
 <div className="text-foreground dark:text-white font-black text-2xl tracking-tighter group-hover:scale-105 transition-transform origin-left">{formatCurrency(product.price)}</div>
