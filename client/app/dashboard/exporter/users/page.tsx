...
export default function ExporterUsersPage() {
 ...
 <div className="relative z-10 flex flex-col items-center text-center p-12 bg-card/40 backdrop-blur-3xl border border-border dark:border-white/5 rounded-lg max-w-lg shadow-2xl">
 <div className="w-20 h-20 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-500 mb-8 animate-pulse">
 <ShieldCheck className="w-10 h-10" />
 </div>
 <h2 className="text-3xl font-black text-foreground dark:text-white uppercase tracking-tighter mb-4">Protocol Breach</h2>
 ...
 <Link href="/dashboard/exporter" className="px-10 py-4 bg-primary text-primary-foreground rounded-lg text-[10px] font-black uppercase tracking-[0.2em] hover:scale-[1.05] transition-all duration-300">
 ...
 <div>
 <h1 className="text-3xl font-black text-foreground dark:text-white tracking-tighter flex items-center gap-4 uppercase ">
 Global Registry
 ...
 <p className="text-muted-foreground text-[10px] font-black uppercase tracking-[0.2em] mt-1.5 opacity-40 ">
 ...
 className="pl-12 pr-10 py-3 bg-muted/50 dark:bg-white/5 border border-border dark:border-white/10 rounded-lg text-xs text-foreground dark:text-white placeholder:text-muted-foreground/20 w-80 outline-none focus:border-[#D4AF37]/50 transition-all font-medium "
 value={search}
 ...
 <select
 className="bg-muted/50 dark:bg-white/5 border border-border dark:border-white/10 rounded-lg px-5 py-3 text-[10px] font-black uppercase tracking-[0.1em] text-muted-foreground outline-none focus:border-[#D4AF37]/50 transition-all cursor-pointer"
 value={roleFilter}
 ...
 <div className="bg-card/40 dark:bg-white/5 backdrop-blur-3xl border border-border dark:border-white/5 shadow-2xl rounded-lg overflow-hidden relative">
 ...
 <th className="px-8 py-6 text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] ">Identified Subject</th>
 <th className="px-8 py-6 text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] ">Sector Hub</th>
 <th className="px-8 py-6 text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] text-center">Protocol Role</th>
 <th className="px-8 py-6 text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] ">Signal Status</th>
 <th className="px-8 py-6 text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em] text-right">Overrides</th>
 </tr>
 </thead>
 ...
 <div className="flex items-center gap-4">
 <div className="size-12 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/10 flex items-center justify-center text-foreground dark:text-white font-black text-xs shadow-inner group-hover:scale-110 transition-transform">
 {u.name?.charAt(0) || u.email.charAt(0).toUpperCase()}
 </div>
 <div>
 <div className="text-sm font-black text-foreground dark:text-white uppercase tracking-wider">{u.name || "UNNAMED ENTITY"}</div>
 ...
 <div className="text-[10px] font-black text-foreground dark:text-white flex items-center gap-2 opacity-80 uppercase">
 ...
 <span className={clsx(
 "text-[8px] font-black tracking-[0.2em] px-3 py-1 rounded-full border uppercase ",
 ...
 className="w-12 h-12 flex items-center justify-center rounded-lg bg-black/5 dark:bg-white/5 border border-border text-muted-foreground hover:text-[#D4AF37] hover:border-[#D4AF37]/50 transition-all disabled:opacity-10 disabled:pointer-events-none"
 >
 <ChevronLeft className="w-5 h-5" />
 </button>
 <div className="h-12 w-12 flex items-center justify-center rounded-lg bg-[#D4AF37] text-white text-[12px] font-black shadow-[0_0_20px_rgba(212,175,55,0.4)]">
 {page}
 </div>
 <button
