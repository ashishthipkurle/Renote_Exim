            ...
            <div className="space-y-4 relative">
                ...
                {shipments.length === 0 ? (
                    <div className="bg-[#151c2a]/60 backdrop-blur-xl border border-white/5 shadow-2xl rounded-[2rem] p-16 text-center">
                        ...
                        <h2 className="text-2xl font-black text-white mb-3 uppercase italic">No Global Logistics ID&apos;d</h2>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="lg:col-span-2">
                                        ...
                                        <div className="text-[9px] text-slate-500 flex items-center gap-1 font-black uppercase tracking-wider mt-1">
                                    ...
                                    <div className="lg:col-span-2">
                                        <div className="text-xs font-black text-slate-400 uppercase tracking-widest bg-white/5 border border-white/5 px-3 py-1.5 rounded-xl w-fit">
