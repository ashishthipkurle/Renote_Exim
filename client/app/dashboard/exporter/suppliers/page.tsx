            ...
            <div className={`flex flex-col border-r border-border shrink-0 transition-all duration-300 ${selectedId ? "w-0 md:w-80 lg:w-[400px]" : "w-full md:w-80 lg:w-[400px]"}`}>
                <div className="p-10 space-y-8">
                    <div className="flex items-center justify-between">
                        ...
                        <Button 
                            className="size-14 rounded-2xl border border-border bg-card/40 hover:bg-primary hover:text-white transition-all shadow-xl dark:shadow-none"
                    ...
                    <div className="relative group/search">
                        ...
                        <input
                            ...
                            className="w-full bg-muted/20 border border-border rounded-2xl pl-14 pr-6 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-bold shadow-inner"
                            value={searchQuery}
                            ...
                            {filteredList.map((node) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full group relative bg-card/40 border transition-all duration-500 rounded-[2.5rem] overflow-hidden p-6 text-left ${isSelected ? "border-primary ring-1 ring-primary/20 shadow-2xl shadow-primary/10" : "border-border hover:border-primary/40 hover:bg-muted/30"}`}
                                    >
                                        <div className="flex items-center gap-5">
                                            <div className="size-16 rounded-[1.8rem] bg-gradient-to-br from-primary to-blue-600/10 flex shrink-0 items-center justify-center text-white font-black text-2xl shadow-lg shadow-primary/10 group-hover:scale-105 transition-transform">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start mb-1">
                                                    ...
                                                    <span className="text-[8px] font-black text-muted-foreground uppercase tracking-widest opacity-40 shrink-0 ml-2 italic">{node.country || "Global"}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <div className="px-2 py-0.5 rounded-lg bg-primary/10 text-primary text-[8px] font-black uppercase tracking-widest border border-primary/10 italic">
                ...
                {selectedId && selectedUser ? (
                    <>
                        ...
                        <header className="p-8 border-b border-border bg-card/60 backdrop-blur-3xl flex items-center justify-between z-20 sticky top-0">
                            <div className="flex items-center gap-6">
                                ...
                                <div className="flex items-center gap-5">
                                    <div className="size-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center font-black text-primary text-xl overflow-hidden shadow-lg shadow-white/5">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Button variant="ghost" size="icon" className="rounded-2xl size-14 border border-border" onClick={() => setIsScheduleModalOpen(true)}>
                                    <CalendarClock className="w-6 h-6" />
                                </Button>
                                <Button variant="ghost" size="icon" className="rounded-2xl size-14 border border-border">
                                    ...
                                    {messagesLoading && messages.length === 0 ? (
                                        ...
                                        <div className="flex-1 flex flex-col items-center justify-center text-center max-w-sm mx-auto opacity-30 space-y-8">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-70 italic text-center">Secure p2p signal active. Transmit trade intelligence.</p>
                                            </div>
                                        </div>
                                    ) : (
                                        messages.map((msg) => {
                                ...
                                {isHistoryOpen && (
                                    ...
                                    >
                                        <div className="p-10 border-b border-border flex items-center justify-between">
                                            <div>
                                                <h3 className="text-xl font-black italic uppercase tracking-tighter">Trade Feed</h3>
                    ...
                    <div className="text-center max-w-md space-y-12 animate-in fade-in zoom-in duration-1000">
                        <div className="relative mx-auto">
                            <div className="size-48 mx-auto rounded-[4rem] bg-gradient-to-br from-primary to-blue-600/[0.05] p-[1.5px] shadow-2xl shadow-primary/20 rotate-6 group">
                        ...
                        <div className="flex gap-4 justify-center">
                            <div className="px-6 py-3 bg-primary/5 border border-primary/10 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] text-primary italic">Secure Node</div>
                            <div className="px-6 py-3 bg-muted/30 border border-border rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground italic">P2P Encryption</div>
                        </div>
                    </div>
                )}
                ...
                {callController.phase !== "idle" && callController.phase !== "ended" && (
                    <div className="absolute inset-0 z-[100] bg-black/95 backdrop-blur-3xl flex flex-col animate-in fade-in duration-500">
                        ...
                        <header className="p-10 flex items-center justify-between">
                            <div className="flex items-center gap-6">
                                <div className="size-20 rounded-[2.5rem] bg-primary/20 border border-primary/30 flex items-center justify-center text-primary font-black text-3xl shadow-2xl shadow-primary/20">
                        ...
                        <div className="flex-1 p-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto w-full">
                            <VideoPlayer 
                                ...
                                image={null}
                                isLocal={false}
                                className="h-[500px] md:h-[600px] border border-white/10 rounded-[4rem] shadow-2xl"
                            />
                        ...
                        <footer className="p-16 flex justify-center">
                            <div className="flex items-center gap-10 p-6 bg-white/[0.03] border border-white/10 rounded-[3rem] backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                                <Button 
                                    variant="ghost" 
                                    size="icon" 
                        ...
                        >
                            <div className="p-12 border-b border-border bg-white/[0.02] backdrop-blur-md flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="size-14 bg-black/5 dark:bg-white/10 border border-border dark:border-white/10 rounded-2xl flex items-center justify-center text-muted-foreground hover:text-foreground transition-all active:scale-90"
                                >
                                    <X className="w-7 h-7" />
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleAddDealer} className="p-12 overflow-y-auto max-h-[70vh] custom-scrollbar">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    {[
                                        ...
                                        <div key={f.k} className="space-y-4 group/field">
                                            <label className="text-[9px] font-black text-muted-foreground/20 uppercase tracking-[0.3em] flex items-center gap-3 italic group-focus-within/field:text-foreground transition-colors">
                                            ...
                                            <input
                                                required={f.r}
                                                type={f.t || "text"}
                                                className="w-full bg-white/[0.02] border border-border rounded-2xl px-6 py-4 text-[11px] text-foreground font-black uppercase tracking-[0.2em] focus:border-primary/30 outline-none transition-all placeholder:text-muted-foreground/10 italic shadow-inner"
                                                placeholder={f.p}
                                ...
                                <div className="mt-10 space-y-4 group/field">
                                    ...
                                    <textarea
                                        className="w-full bg-white/[0.02] border border-border rounded-[2rem] px-8 py-6 text-[11px] text-foreground font-black uppercase tracking-[0.2em] focus:border-primary/30 outline-none transition-all placeholder:text-muted-foreground/10 min-h-[120px] resize-none italic shadow-inner leading-relaxed"
                                ...
                                <div className="mt-12 flex gap-6">
                                    <button
                                        type="button"
                                        onClick={() => setIsAddDealerModalOpen(false)}
                                        className="flex-1 py-5 bg-muted hover:bg-muted/80 text-muted-foreground rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] transition-all italic border border-border"
                                    >
                                        Abort Registration
                                    </button>
                                    <button
                                        ...
                                        className="flex-[2] py-5 bg-primary hover:bg-primary-hover text-white rounded-2xl font-black shadow-2xl shadow-primary/20 transition-all disabled:opacity-20 flex items-center justify-center gap-4 text-[10px] uppercase tracking-[0.3em] italic active:scale-95 group"
                                    >
