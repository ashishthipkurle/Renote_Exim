...
export default function ExporterNotificationsPage() {
 ...
 <p className="text-[10px] font-black text-foreground dark:text-white uppercase tracking-[0.4em] ">Indexing Comms Hub...</p>
 </div>
 </div>
 );
 ...
 <h1 className="text-5xl font-black tracking-tighter text-foreground dark:text-white uppercase ">Signal Center</h1>
 ...
 <p className="text-muted-foreground/40 text-[10px] font-black uppercase tracking-[0.3em] max-w-xs hidden xl:block">
 ...
 className="inline-flex items-center gap-3 bg-black/5 dark:bg-white/10 hover:bg-primary hover:text-primary-foreground disabled:opacity-20 text-foreground dark:text-white font-black text-[10px] uppercase tracking-[0.2em] py-4 px-10 rounded-lg border border-border dark:border-white/10 transition-all active:scale-95 group shadow-xl dark:shadow-2xl backdrop-blur-3xl"
 >
 ...
 className={`px-8 py-3 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${statusFilter === s ? "bg-primary text-primary-foreground shadow-xl dark:shadow-2xl scale-105" : "text-muted-foreground/40 hover:text-foreground dark:text-white"}`}
 >
 ...
 <div key={i} className="h-32 bg-card/40 dark:bg-white/5 rounded-lg animate-pulse border border-border dark:border-white/5 shadow-2xl shadow-white/2" />
 ))
 ) : !filteredNotifications?.length ? (
 <div className="bg-card/40 dark:bg-white/5 backdrop-blur-3xl border border-border dark:border-white/5 shadow-xl dark:shadow-2xl rounded-lg p-24 text-center mt-10">
 ...
 <h2 className="text-2xl font-black text-foreground dark:text-white uppercase tracking-tighter">Null_Signal_Feed</h2>
 ...
 className={`group relative bg-card/40 dark:bg-white/5 backdrop-blur-3xl border rounded-lg p-8 flex gap-8 items-center transition-all duration-700 cursor-pointer overflow-hidden shadow-xl dark:shadow-2xl ${n.read
 ...
 <div className={`size-16 flex-shrink-0 rounded-lg border flex items-center justify-center transition-all duration-700 ${!n.read
 ...
 <div className="text-[9px] font-black text-muted-foreground/30 uppercase tracking-[0.3em] whitespace-nowrap group-hover:text-muted-foreground/60 transition-colors">
 TELEMETRY_LAG: {timeAgo(n.createdAt)}
 </div>
 </div>
 <p className={`text-xs font-black uppercase tracking-tight leading-relaxed line-clamp-2 ${n.read ? "text-muted-foreground/20" : "text-muted-foreground/60 group-hover:text-muted-foreground/80"}`}>
 {n.message}
 </p>
 </div>

 <div className="size-12 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-700 -translate-x-4 group-hover:translate-x-0">
 ...
 <div className="max-w-[1200px] mx-auto bg-card/60 dark:bg-white/[0.07] border border-border dark:border-white/10 rounded-lg p-12 flex flex-col xl:flex-row items-center gap-10 shadow-xl dark:shadow-2xl relative overflow-hidden group">
 ...
 <div className="size-20 rounded-lg bg-black/5 dark:bg-white/10 border border-border dark:border-white/10 flex items-center justify-center shrink-0 relative z-10 transition-all duration-1000 group-hover:scale-110">
 <Info className="w-10 h-10 text-foreground dark:text-white" />
 </div>
 <div className="relative z-10">
 <h3 className="text-foreground dark:text-white font-black text-2xl uppercase tracking-tighter mb-4">Registry Protocol Override</h3>
