    ...
    <div className="p-4 sm:p-8 max-w-5xl mx-auto space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
              ...
              {isMfaEnabled ? (
                ...
                <div className="pt-2">
                  {!enrollData ? (
                    ...
                    <div className="p-6 rounded-2xl bg-muted/40 border border-border relative">
                      <button 
          ...
          <section className="bg-card border border-border rounded-2xl p-6 flex items-center justify-between group cursor-not-allowed opacity-60">
