...
export default function AdminLogsPage() {
 ...
 <p className="text-slate-500 text-xs font-medium ">Monitoring platform volatility and entity transmissions.</p>
 </div>
 ...
 <div className="text-[8px] text-slate-600 font-medium truncate max-w-[200px] ">
 {log.userAgent}
 </div>
 </div>
 </td>
