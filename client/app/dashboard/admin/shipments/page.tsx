...
export default function AdminShipmentsPage() {
 ...
 <p className="text-slate-500 text-xs font-medium ">Global transit monitoring and carrier coordination.</p>
 </div>
 ...
 <div className="h-64 flex items-center justify-center text-slate-500 font-medium border border-dashed border-white/10 rounded-lg uppercase tracking-widest text-[10px]">
 ...
 className="group bg-muted/40 backdrop-blur-xl border border-border rounded-lg overflow-hidden hover:border-white/30 transition-all shadow-xl"
 >
