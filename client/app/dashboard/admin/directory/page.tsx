...
export default function AdminDirectoryPage() {
 ...
 <p className="text-slate-500 text-xs font-medium ">Global network census and verified partner lookup.</p>
 </div>
 ...
 <div className="col-span-full h-64 flex items-center justify-center border border-dashed border-white/10 rounded-lg text-slate-500 uppercase tracking-widest text-[10px] font-black">
 ...
 className="group bg-muted/40 backdrop-blur-xl border border-border p-6 rounded-lg hover:border-white/30 transition-all shadow-xl overflow-hidden relative"
 >
 {/* Visual Identity */}
