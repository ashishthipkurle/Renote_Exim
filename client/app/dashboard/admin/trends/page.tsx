      ...
      <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                {loading ? (
                  ...
                  data?.topProducts.map((p, i) => (
                    <motion.div
                      ...
                      className="group bg-white/5 border border-white/5 p-4 rounded-2xl hover:border-white/30 transition-all flex items-center gap-4"
                    >
          ...
          <div className="xl:col-span-4 space-y-8">
            <div className="bg-muted/40 backdrop-blur-xl border border-border p-8 rounded-3xl shadow-2xl flex flex-col min-h-full">
              <div className="mb-8">
                <h3 className="text-white font-black text-lg uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="mt-8 p-6 bg-white/10 border border-white/20 rounded-2xl relative overflow-hidden group">
