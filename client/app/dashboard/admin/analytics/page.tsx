...
export default function AdminAnalyticsPage() {
 ...
 <p className="text-slate-500 text-xs font-medium ">High-fidelity platform performance and growth metrics.</p>
 </div>
 ...
 className="bg-muted/40 backdrop-blur-xl border border-border p-6 rounded-lg group hover:border-white/30 transition-all shadow-xl"
 >
 ...
 {/* Main Growth Chart */}
 <div className="xl:col-span-2 bg-muted/40 backdrop-blur-xl border border-border p-8 rounded-lg relative overflow-hidden h-[450px]">
 ...
 {/* Sector Distribution */}
 <div className="bg-muted/40 backdrop-blur-xl border border-border p-8 rounded-lg h-[450px] flex flex-col">
 <div className="mb-8">
 <h3 className="text-white font-black text-lg uppercase tracking-widest flex items-center gap-2">
 ...
 <div className="mt-8 bg-gradient-to-r from-white/5 via-transparent to-white/5 border border-border p-12 rounded-lg flex flex-col items-center justify-center text-center space-y-4">
