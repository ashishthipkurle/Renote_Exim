...
export default function AdminDashboard() {
 ...
 className="bg-muted/60 backdrop-blur-xl border border-border shadow-2xl p-6 rounded-lg relative overflow-hidden group hover:border-white/40 transition-all cursor-default"
 >
 ...
 <div className="bg-muted/40 backdrop-blur-md border border-border rounded-lg overflow-hidden">
 {loading ? (
 ...
 <div className="bg-muted/60 backdrop-blur-xl border border-border shadow-2xl rounded-lg p-6">
