...
export default function AdminOrdersPage() {
 ...
 <p className="text-slate-500 text-xs font-medium font-mono uppercase tracking-tighter">Monitoring platform-wide commerce activity.</p>
 </div>
 ...
 <tr>
 <td colSpan={5} className="px-6 py-12 text-center text-slate-500 text-sm font-medium ">No transactions detected in current sector.</td>
 </tr>
 ) : (
 orders.map((o) => (
