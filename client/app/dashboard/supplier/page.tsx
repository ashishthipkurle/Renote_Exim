...
export default function SupplierDashboard() {
 ...
 >
 <Card className="bg-card/30 border-white/5 shadow-2xl rounded-lg overflow-hidden group">
 ...
 <h2 className="text-3xl font-black tracking-tighter tabular-nums">{stats?.totalExporters || 0}</h2>
 </div>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-8 space-y-6">
 <div className="flex items-center justify-between">
 <div className="size-14 rounded-lg bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] group-hover:scale-110 transition-transform">
 <Boxes className="w-7 h-7" />
 </div>
 <div className="text-muted-foreground font-bold text-xs opacity-40">
 Global Stock
 </div>
 </div>
 <div>
 <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground opacity-50 mb-1">Total Products</p>
 <h2 className="text-3xl font-black tracking-tighter tabular-nums">{stats?.totalProducts || 0}</h2>
 </div>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-8 space-y-6">
 <div className="flex items-center justify-between">
 <div className="size-14 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-500 group-hover:scale-110 transition-transform">
 <FolderTree className="w-7 h-7" />
 </div>
 <div className="flex items-center gap-1 text-blue-400 font-bold text-[10px] uppercase tracking-widest animate-pulse">
 ...
 <h2 className="text-3xl font-black tracking-tighter tabular-nums">{stats?.activeOrders || 0}</h2>
 </div>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-8 space-y-6">
 <div className="flex items-center justify-between">
 <div className="size-14 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
 ...
 <Card className="bg-card/10 border-white/5 rounded-lg shadow-2xl overflow-hidden min-h-[400px]">
 ...
 <div className="size-20 rounded-lg bg-muted/20 border border-white/5 flex items-center justify-center">
