...
export default function ImporterRFQs() {
 ...
 <div>
 <h1 className="text-3xl font-black text-foreground tracking-tight uppercase ">Sourcing Protocols</h1>
 ...
 <DialogHeader>
 <DialogTitle className="text-2xl font-black uppercase tracking-tighter">Broadcast Sourcing Protocol</DialogTitle>
 </DialogHeader>
 ...
 {[1, 2, 3].map(i => (
 <div key={i} className="h-32 bg-muted/20 rounded-lg animate-pulse border border-border" />
 ))}
 </div>
 ) : rfqs.length === 0 ? (
 <div className="text-center py-20 bg-muted/20 border-2 border-dashed border-border rounded-lg shadow-xl">
 <div className="w-16 h-16 bg-muted/20 rounded-lg flex items-center justify-center mx-auto mb-6 text-muted-foreground border border-border">
 <FileText className="w-8 h-8" />
 </div>
 <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">Transmission Node Vacant</h3>
 ...
 className="group p-6 bg-muted/40 backdrop-blur-xl border border-border rounded-lg hover:border-border shadow-xl transition-all block"
 >
 ...
 <h3 className="text-xl font-black text-foreground group-hover:text-muted-foreground transition-all uppercase tracking-tighter">
 {rfq.title}
 </h3>
 </div>
 ...
 <div className="p-6 bg-muted/20 border border-border rounded-lg shadow-xl">
 <h4 className="text-foreground font-black uppercase tracking-widest text-[10px] mb-4 flex items-center gap-2 ">
 ...
 <div className="p-6 border border-border rounded-lg bg-muted/40 shadow-xl">
 <h4 className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-6 ">Active Streams</h4>
 <div className="space-y-4">
 <div className="flex justify-between items-center">
 <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Open Requests</span>
 <span className="text-sm font-black text-foreground ">{rfqs.filter(r => r.status === 'OPEN').length}</span>
 </div>
 <div className="flex justify-between items-center">
