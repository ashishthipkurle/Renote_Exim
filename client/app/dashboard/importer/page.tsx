...
export default function ImporterDashboard() {
 ...
 <div>
 <h2 className="text-2xl font-black text-foreground tracking-tight uppercase ">Global Trade Overview</h2>
 ...
 {stats.map((s) => (
 <div key={s.label} className={`bg-muted/40 backdrop-blur-xl p-6 rounded-lg border border-border relative overflow-hidden group ${s.hoverBorder} transition-all duration-300 shadow-xl`}>
 ...
 <div className="bg-muted/40 backdrop-blur-xl rounded-lg p-6 border border-border relative overflow-hidden flex flex-col lg:flex-row gap-6 shadow-xl">
 <div className="flex-1">
 <div className="flex items-center justify-between mb-6">
 <div>
 <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">Expenditure Analytics</h3>
 ...
 <div className="flex items-center justify-center h-full text-muted-foreground text-[10px] font-black uppercase tracking-[0.2em] opacity-30">SIGNAL TRACE INDETERMINATE</div>
 ) : (
 ...
 <div className="bg-muted/40 backdrop-blur-xl rounded-lg p-6 border border-border shadow-xl">
 <div className="flex items-center justify-between mb-6">
 <div>
 <h3 className="text-lg font-black text-foreground uppercase tracking-tighter">Procurement Trend</h3>
 ...
 <div className="absolute inset-0 flex items-center justify-center text-muted-foreground font-black text-[10px] uppercase tracking-[0.2em] z-20 pb-8 opacity-40 animate-pulse">SYNCHRONIZING TELEMETRY...</div>
 ) : (
 <>
 ...
 {/* Quick Actions */}
 <div className="bg-muted/40 backdrop-blur-xl p-6 rounded-lg border border-border shadow-xl">
 <h3 className="text-lg font-black text-foreground uppercase tracking-tighter mb-5">Quick Actions</h3>
 ...
 <div className="bg-muted/40 backdrop-blur-xl p-6 rounded-lg border border-border shadow-xl flex flex-col h-[400px]">
 <div className="flex items-center justify-between mb-5">
 <h3 className="text-lg font-black text-foreground uppercase tracking-tighter">Recent Logistics</h3>
