...
export default function ImporterCategoriesPage() {
 ...
 className="bg-muted border border-border rounded-lg py-3.5 pl-11 pr-4 text-foreground font-black text-sm focus:ring-2 focus:ring-white/20 outline-none w-64 transition-all placeholder:text-muted-foreground/20 shadow-inner uppercase tracking-widest"
 />
 </div>
 <button className="p-3.5 rounded-lg bg-muted border border-border text-muted-foreground hover:text-foreground transition-all shadow-xl">
 ...
 <div key={i} className="h-48 bg-muted/20 rounded-lg animate-pulse border border-border" />
 ))}
 </div>
 ...
 <h3 className="text-foreground font-black uppercase tracking-widest ">No Categories Found</h3>
...
function CategoryCard({
 ...
 return (
 <div className={`group bg-muted/40 backdrop-blur-xl border border-border shadow-2xl rounded-lg p-7 transition-all hover:scale-[1.03] hover:border-border`}>
 <div className="flex justify-between items-start mb-8">
 <div className="flex items-center gap-4">
 <div className="size-14 rounded-lg bg-muted/20 border border-white/5 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform shadow-xl">
 {style.icon}
 </div>
 <div>
 <div className="text-foreground font-black text-xl tracking-tighter uppercase leading-none ">{category.name}</div>
 ...
 <div className="bg-muted/40 rounded-lg p-4 border border-border shadow-xl">
 <div className="text-[9px] text-muted-foreground font-black uppercase tracking-widest mb-1.5">Items Ordered</div>
 <div className="text-foreground font-black flex items-center gap-3 text-sm tracking-tighter">
 ...
 <div className="text-foreground font-black text-sm tracking-tighter shadow-[0_0_10px_rgba(255,255,255,0.1)]">
 ...
 <span className="text-foreground tracking-tighter">{Math.round((category.spent / maxSpent) * 100)}%</span>
 </div>
 ...
 <button className="text-[10px] font-black text-foreground uppercase tracking-tighter flex items-center gap-2 group/btn">
 Explore
