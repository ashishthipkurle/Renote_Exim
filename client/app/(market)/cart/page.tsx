      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8 py-8">
        <div className="flex items-center justify-between mb-8 border-b border-border">
          ...
          <div className="pb-4 hidden sm:block">
            <p className="text-sm text-muted-foreground italic">“Free shipping on orders over $5,000”</p>
          </div>
        </div>
        ...
        {!loading && items.length > 0 && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              {rows.map(({ item, product }) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="rounded-2xl border border-border bg-card/80 dark:bg-card/40 backdrop-blur-sm p-4 flex flex-col sm:flex-row gap-6 hover:bg-accent/30 transition-colors"
                  >
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-28 rounded-2xl border border-border bg-card/80 dark:bg-card/40 backdrop-blur-sm p-6">
                ...
                <Link
                  href="/checkout"
                  className="w-full inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground font-black py-4 rounded-2xl shadow-xl shadow-primary/20 transition-all active:scale-[0.98]"
                >
