...
export default function OrdersPage() {
 ...
 <div className="rounded-lg border border-border bg-card/80 dark:bg-card/40 backdrop-blur-sm overflow-hidden shadow-2xl">
 ...
 <div className="absolute bottom-6 right-6 p-4 rounded-lg border border-border bg-background/60 backdrop-blur-sm max-w-[240px]">
 ...
 <div
 key={o.id}
 className="rounded-lg border border-border bg-card/80 dark:bg-card/40 backdrop-blur-sm p-4 hover:border-primary/30 transition-colors flex items-center gap-4"
