            ...
            <div className="rounded-2xl border border-border bg-card/80 dark:bg-card/40 backdrop-blur-sm p-6">
              ...
              <form className="mt-6" action="/products" method="GET">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="h-11 flex-1 rounded-xl border border-input bg-background/60 px-4 text-sm outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/60"
                    placeholder="Search products..."
                  />
                  <button
                    type="submit"
                    className="h-11 px-4 rounded-xl bg-primary text-primary-foreground text-sm font-bold hover:bg-primary/90 transition-colors"
                  >
                    Go
                  </button>
                </div>
              ...
              <form className="mt-6" action="/products" method="GET">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button type="submit" className="h-11 px-3 rounded-xl bg-primary/10 text-primary text-sm font-bold hover:bg-primary/20 transition-colors">
                    Apply
                  </button>
                </div>
              </form>
              ...
              <form className="mt-6" action="/products" method="GET">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input name="minPrice" type="number" defaultValue={minPriceParam ?? ""} className="h-11 w-full rounded-xl border border-input bg-background/60 px-4 text-sm outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/60" placeholder="Min" />
                  <input name="maxPrice" type="number" defaultValue={maxPriceParam ?? ""} className="h-11 w-full rounded-xl border border-input bg-background/60 px-4 text-sm outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/60" placeholder="Max" />
                </div>
                <button type="submit" className="mt-3 w-full h-10 rounded-xl bg-primary/10 text-primary text-sm font-bold hover:bg-primary/20 transition-colors">
                  Apply Price Filter
                </button>
              </form>
          ...
          <section className="lg:col-span-8 xl:col-span-9">
            ...
            {totalPages > 1 && (
              <div className="mt-8 flex items-center justify-center gap-2">
                {page > 1 && (
                  <Link href={buildUrl({ page: (page - 1).toString() })} className="px-4 py-2 rounded-xl border border-border bg-background/60 text-sm font-semibold hover:border-primary/40 transition-colors">
                    ← Previous
                  </Link>
                )}
